...
const AdminCricketTable = ({ sportId = 4 }) => {
  ...
  // ---- Filtered Matches ----
  const filteredMatches = (optimisticMatches.length > 0 ? optimisticMatches : matches).filter(
    (match) =>
      Array.isArray(match.matchRunners) &&
  ...
  // ---- Optimistic UI Handlers (without socket) ----
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        <h1 className="mb-4">Cricket: Upcoming, Today, Tomorrow & Live Matches</h1>
